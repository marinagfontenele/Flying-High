    ...
    var body: some View {
        NavigationStack{
            ...
            .background(Color.background
                .ignoresSafeArea())
            .fullScreenCover(item: $cardSelecionado){ item in TelaCheiaPostView(content: item, tituloDoPost: "Artigo")
            }
        }
    }
...
struct TelaCheiaPostView: View{
    ...
    var corDeFundo: Color{
        ...
        case "Dicas de Organização": return Color("card_organizacao")
    ...
    var nomeImage: String{
        switch tituloDoPost {
        case "Banheiro": return "bucket"
        case "Organização": return "house"
        case "Reparos":return "hammer"
    ...
    var textoArtigo: String {
        ...
        case "Oragnização" : return "Organizacao"
